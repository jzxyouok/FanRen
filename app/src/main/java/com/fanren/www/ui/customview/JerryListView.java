...
import com.fanren.www.impl.OnRefreshListener;
 ...
 *
 */
public class JerryListView extends ListView implements OnScrollListener,AdapterView.OnItemClickListener{
	...
	public JerryListView(Context context) {
		super(context);
		init();
	}

	public JerryListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public JerryListView(Context context, AttributeSet attrs, int defStyle) {
